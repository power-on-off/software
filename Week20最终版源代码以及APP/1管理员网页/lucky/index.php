...
<body>
	...
	<h1 align="center">幸运签管理</h1>
	<form action="" method="post" name="indexf">
		<p align="center"><input type="button" value="新增幸运签" name="inbut" onClick="location.href='insert.php'" /></p>
		<p align="center"><input type="text" name="sel" /><input type="submit" value = "搜索" name="selsub" /></p>
    	
        
		<table class="table" align="center" border="1px" cellspacing="0px" width="800px">
			<tr><th>序号</th><th>幸运签署名</th><th>内容</th><th>操作</th></tr>
<?php
	session_start();
	...
	if (empty($_POST["selsub"])) {
		$res = mysqli_query($link,"SELECT * from lucky_sign order by id");
	} else {
		$sel = $_POST["sel"];
