    ...
    export default {
        ...
        onLoad() {
			...
			uni.showModal({
				...
				content: '您确定要进行数据导出吗？',
				editable:true,
				placeholderText:"请输入导出的文件夹名(建议使用日期)",
                    ...
                    dirEntry1.getFile(`${xlsxName}.xlsx`, {
                        ...
                        fileEntry.createWriter(function(writer) {
                            ...
                            writer.onwrite = (e) => {
                                ...
                                setTimeout(()=>{	
                                    that.NumSteps();
									that.filePath = `数据导出成功！文件夹位置： ${pathStr}/${documentName}/${fileName}`;
                                },500) 
                            };
                            // 写入内容;
